...
It lists project groups, temporary sessions, linked projects, session cache paths, creation time, update time, and message counts. Before deletion, it generates a cleanup plan and requires a second confirmation to reduce accidental deletes.
...
![Session list and grouped view](doc/images/session-list.png)

Second confirmation before deletion:

<img src="doc/images/delete-confirm.png" alt="Delete confirmation dialog" width="60%">

## Features

- View local Codex conversation history in the browser
- Group sessions by project directory, with temporary sessions separated
...
Different Codex clients may store and manage sessions differently. Prefer the deletion flow built into the client you used. This tool is best treated as a visual local manager and supplemental cleanup tool.
